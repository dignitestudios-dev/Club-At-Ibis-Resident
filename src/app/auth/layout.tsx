...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative min-h-svh flex flex-col justify-between overflow-y-auto bg-slate-950 select-none">
      ...
      <div className="pointer-events-none fixed -right-16 -bottom-12 select-none opacity-15 lg:opacity-25 z-0 transition-opacity">
        <Image
      ...
      {/* Main Center Auth Card with Content-Driven Height & Scrollable Body on Small Screens */}
      <main className="relative z-10 flex flex-1 items-center justify-center px-4 py-4 sm:px-6 sm:py-6">
        <div className="relative w-full max-w-[460px] h-auto max-h-[calc(100svh-4.5rem)] sm:max-h-[calc(100svh-5.5rem)] flex flex-col rounded-2xl border border-white/30 dark:border-white/10 bg-white/95 dark:bg-[#121c2d]/95 shadow-2xl backdrop-blur-xl overflow-hidden animate-in fade-in zoom-in-95 duration-300 my-auto">
